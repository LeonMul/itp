            ...
            <ol>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-1-answers-D">D) 21 </label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-2-answers-D">D) 12 </label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-3-answers-A">A) 12 &times; 0 = 0</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-B" value="B" />
                        <label for="question-3-answers-B">B) 5 &times; 5 = 25</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-C" value="C" />
                        <label for="question-3-answers-C">C) 3 &times; 6 = 18</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-D" value="D" />
                        <label for="question-3-answers-D">D) 4 &times; 9 = 13 </label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-4-answers-B">B) 2 &divide; 2 = 4</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-4-answers" id="question-4-answers-C" value="C" />
                        <label for="question-4-answers-C">C) 18 &divide; 3 = 6</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-4-answers" id="question-4-answers-D" value="D" />
                        <label for="question-4-answers-D">D) 24 &divide; 12 = 12</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-5-answers-C">C) 9 </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-D" value="D" />
                        <label for="question-5-answers-D">D) 12 </label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-6-answers-A">A) 7 </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-6-answers" id="question-6-answers-B" value="B" />
                        <label for="question-6-answers-B">B) 31 </label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-7-answers-A">A) 7</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-7-answers" id="question-7-answers-B" value="B" />
                        <label for="question-7-answers-B">B) 56</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-7-answers" id="question-7-answers-C" value="C" />
                        <label for="question-7-answers-C">C) 42</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-7-answers" id="question-7-answers-D" value="D" />
                        <label for="question-7-answers-D">D) 8</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-8-answers-A">A) 1 &times; 0 = 0</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-8-answers" id="question-8-answers-B" value="B" />
                        <label for="question-8-answers-B">B) 9 &times; 9 = 81</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-8-answers" id="question-8-answers-C" value="C" />
                        <label for="question-8-answers-C">C) 8 &times; 6 = 14</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-8-answers" id="question-8-answers-D" value="D" />
                        <label for="question-8-answers-D">D) 2 &times; 8 = 16 </label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-9-answers-A">A) 18 + 2 = 16</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-9-answers" id="question-9-answers-B" value="B" />
                        <label for="question-9-answers-B">B) 10 + 10 = 20</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-9-answers" id="question-9-answers-C" value="C" />
                        <label for="question-9-answers-C">C) 7 + 13 = 6</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-9-answers" id="question-9-answers-D" value="D" />
                        <label for="question-9-answers-D">D) 1 + 1 = 11</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-10-answers-A">A) 17</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-10-answers" id="question-10-answers-B" value="B" />
                        <label for="question-10-answers-B">B) 15</label>
                    </div>
                    ...
                    <div>
                        ...
                        <label for="question-10-answers-D">D) 20</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-14-answers-A">A) 5 + 1 = 7</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-14-answers" id="question-4-answers-B" value="B" />
                        <label for="question-14-answers-B">B) 19 + 2 = 20 </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-14-answers" id="question-14-answers-C" value="C" />
                        <label for="question-14-answers-C">C) 18 + 5 = 23</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-14-answers" id="question-14-answers-D" value="D" />
                        <label for="question-14-answers-D">D) 6 + 18 = 12</label>
                    </div>
