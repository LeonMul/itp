...
<body>
    ...
    <div class=" container">
      <div class=" row medPadding">
        ...
        <div class="col-md-4 text-justify smlPadding"></div>
              ...
              if ($answer1 == "D") { $totalCorrectS++; }
              if ($answer2 == "A") { $totalCorrectS++; }
              if ($answer3 == "B") { $totalCorrectS++; }
              if ($answer4 == "C") { $totalCorrectS++; }
              if ($answer5 == "B") { $totalCorrectS++; }
              if ($answer6 == "A") { $totalCorrectS++; }
              if ($answer7 == "D") { $totalCorrectS++; }
              if ($answer8 == "A") { $totalCorrectS++; }
              if ($answer9 == "C") { $totalCorrectS++; }
              if ($answer10 == "C") { $totalCorrectS++; }
                          ...
                          //Grab the current users score from the database and save it as a php variable ($dbUserScore)
                                          $sql = "SELECT score FROM subtractionQuiz WHERE email='{$_SESSION['$myemail']}'";
                          ...
                          if($dbUserScore<$totalCorrectS){
                                  $sql="REPLACE INTO subtractionQuiz(email,score) VALUES('{$_SESSION['$myemail']}','$totalCorrectS')";
                          ...
                          $sql="INSERT INTO subtractionQuiz(email,score) VALUES('{$_SESSION['$myemail']}','$totalCorrectS')";
  ...
  <div class="container">
    ...
    <div class="col-md-6">
      <h1>Final Quiz
      Grade</h1><?php echo "<div id='results'>$totalCorrectS / 10 correct</div>";
                                      ?><br />
