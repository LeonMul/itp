...
<body>
  ...
  <!-- php saves score as var and then creates connection with db and sends data to the db--><?php
              ...
              if ($answer10 == "A") { $totalCorrectAddition++; }
                          ...
                          //Grab the current users score from the database and save it as a php variable ($dbUserScore)
                                          $sql = "SELECT score FROM additionQuiz WHERE email='{$_SESSION['$myemail']}'";
                          ...
                          if($dbUserScore<$totalCorrectAddition){
                                  $sql="REPLACE INTO additionQuiz(email,score) VALUES('{$_SESSION['$myemail']}','$totalCorrectAddition')";
                          ...
                          $sql="INSERT INTO additionQuiz(email,score) VALUES('{$_SESSION['$myemail']}','$totalCorrectAddition')";
  ...
  <div class="container">
    ...
    <div class="col-md-6">
      <h1>Final Quiz
      Grade</h1><?php echo "<div id='results'>$totalCorrectAddition / 10 correct</div>";
                                      ?><br />
