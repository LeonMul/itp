		...
		<body class="">
				...
				<div class=" container">
					<div class=" row smlPadding">
						...
						<div class="col-md-4 text-center smlPadding whiteText"> 
								...
								<h2>View your progress below!</h2>
							</br>
						</div>
				...
				<div class="container">
					<div class=" row lrgPadding">
						<div class="col-md-12 text-center smlPadding"> 	
							...
							<h3>Below you will find some of our main topics. <br /> These include activities to test your knowledge in the four most prominent maths subjects.</h3>
						</div>							
					</div>
				</div>
			...
			<hr class="shortHr" />
				<div class="container">
					<div class=" row lrgPadding">
						<div class="col-md-3 text-center smlPadding"> 	
							<a href="QuizAddition.php"  class="subjectHomeImg"><img class ="subjectHomeImg" src="images/addition2.png"></a>
							<h3><strong>Addition</strong></h3>
							<p></p>
						</div>							
						
						<div class="col-md-3 text-center smlPadding"> 
							<a href="QuizSubtraction.php" class="subjectHomeImg"><img class ="subjectHomeImg" src="images/subtraction2.png"></a>
							<h3><strong>Subtraction</strong></h3>							
						</div>
						
						<div class="col-md-3 text-center smlPadding"> 
							<a href="QuizMulti.php" class="subjectHomeImg"><img class="subjectHomeImg" src="images/multiplication2.png"></a>
							<h3><strong>Multiplication</strong></h3>								
						</div>		
						
						<div class="col-md-3 text-center smlPadding"> 
							<a href="QuizDivision.php" class="subjectHomeImg"><img class ="subjectHomeImg" src="images/division2.png"></a>
				...
				<div class="container">
					<div class=" row lrgPadding">
						<div class="col-md-12 text-center smlPadding"> 	
							<h2><strong>Your local vicinity!</strong></h2>
				...
				<div class ="homeSection3">
					<div class="container ">
						<div class=" row lrgPadding">
							...
							<div class="col-md-3 text-center smlPadding"> 
								<a href="Quiz.html" class="subjectHomeImg"><img class ="iconSetHome" src="images/squares.png"></a>
			...
			<div class="container padding darkGreyText" id="contact">
				...
				<div class="col-md-8 text-center smlPadding darkGreyText"> 
					<h2><strong>Subscribe to our weekly newsletter!</strong></h2>
						...
						<form name="newsletter" method="POST" action="newsletter.php" class="form">
						  ...
						  <div class="form-group">
							...
							<input type="text" name="email" value="" class="form-control" required>
						 	...
						 	<button type="submit" name="submit" value="submit" class="btn greenHoverBtn roundBtn">Recieve Newsletter!</button>
						</form>		
            	</div>
            		<div class="col-md-2 text-center smlPadding">
					</div> 
