				...
				<div class=" container">
					<div class=" row medPadding">
						...
						<br/>
								...
								<br/>
								<br/>
								<img src="images/Subtraction-Quiz.png">
						</div>							
            ...
            <ol>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-3-answers-A">A) 11 - 1 = 10</label>
                    </div>
                    ...
                    <div>
                        ...
                        <label for="question-3-answers-C">C) 9 - 6 = 3</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-D" value="D" />
                        <label for="question-3-answers-D">D) 12 - 8 = 4 </label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-4-answers-A">A) 4 - 2 = 6</label>
                    </div>
                    ...
                    <div>
                        ...
                        <label for="question-4-answers-C">C) 12 - 5 = 7</label>
                    </div>
                ...
                <li>
                    ...
                    <h3>Which number makes this sum correct 12 - __ = 10</h3>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-6-answers-D">D) 3</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-7-answers-C">C) 6</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-7-answers" id="question-7-answers-D" value="D" />
                        <label for="question-7-answers-D">D) 5</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-8-answers-A">A) 10 - 0 = 11</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-8-answers" id="question-8-answers-B" value="B" />
                        <label for="question-8-answers-B">B) 6 - 6 = 0</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-8-answers" id="question-8-answers-C" value="C" />
                        <label for="question-8-answers-C">C) 5 - 1 = 4</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-8-answers" id="question-8-answers-D" value="D" />
                        <label for="question-8-answers-D">D) 11 - 8 = 3 </label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-9-answers-A">A) 8 - 2 = 7</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-9-answers" id="question-9-answers-B" value="B" />
                        <label for="question-9-answers-B">B) 12 - 2 = 14</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-9-answers" id="question-9-answers-C" value="C" />
                        <label for="question-9-answers-C">C) 9 - 4 = 5</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-9-answers" id="question-9-answers-D" value="D" />
                        <label for="question-9-answers-D">D) 10 - 6 = 5</label>
                    </div>
                ...
                <li>
                    ...
                    <h3>Which number makes this sum correct 8 - __ = 6</h3>
                    ...
                    <div>
                        ...
                        <label for="question-10-answers-B">B) 3</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-10-answers" id="question-10-answers-C" value="C" />
                        <label for="question-10-answers-C">C) 2</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-10-answers" id="question-10-answers-D" value="D" />
                        <label for="question-10-answers-D">D) 0</label>
                    </div>
